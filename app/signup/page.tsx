  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#F7F6F3] flex items-center justify-center">
        <div className="bg-white border border-[#E5E4E0] rounded-xl p-8 w-[400px] text-center">
          ...
          <h2 className="text-[16px] font-semibold text-[#1C1C1C] mb-2">Check your email</h2>
    ...
    <div className="min-h-screen bg-[#F7F6F3] flex items-center justify-center">
      <div className="bg-white border border-[#E5E4E0] rounded-xl p-8 w-[400px]">
        ...
        <div className="mb-8">
          ...
          <p className="text-[13px] text-[#6B7280] mt-1">Create your account</p>
        </div>
